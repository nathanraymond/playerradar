...
from main import PlayerName, Season, FullPlayerName
...
plt.figtext(0.1,0.93,FullPlayerName+" ("+str(Season)+")",color="Lime", fontsize=15, fontweight='bold')

plt.figtext(0.1,0.885,str(int(ShotStats(PlayerName, Season).total_goals()))+" goals & "+str(int(PassingStats(PlayerName, Season).get_assists()))+" assists in "+str(int(PassingStats(PlayerName, Season).get_mins()))+" league minutes", color="magenta", fontsize=11, fontweight='bold')
...
axes.fill(data, alpha=0.5, color="Lime")
